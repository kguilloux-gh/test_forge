...
EOS
            ...
            config {
				...
				volumes = ["/var/lib/osd/mounts/forge-gitlab-data,io_priority=high,size=5,repl=2:/var/opt/gitlab",
				           "/var/lib/osd/mounts/forge-gitlab-logs,io_priority=high,size=2,repl=2:/var/log/gitlab",
				           "/var/lib/osd/mounts/forge-gitlab-config,io_priority=high,size=2,repl=2:/etc/gitlab",
